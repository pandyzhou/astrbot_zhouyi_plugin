...
_ALLOWED_API_ROUTES = (
    ...
    ("GET", "/v1/memory/objects"),
    ("POST", "/v1/memory/objects/create"),
    ("GET", "/v1/memory/objects/detail"),
    ("POST", "/v1/memory/objects/update"),
    ("GET", "/v1/memory/objects/revisions"),
    ("GET", "/v1/memory/objects/sources"),
    ("POST", "/v1/memory/objects/merge/preview"),
    ("POST", "/v1/memory/objects/merge"),
    ("POST", "/v1/memory/objects/supersede"),
    ("POST", "/v1/memory/objects/archive"),
    ("POST", "/v1/memory/objects/batch"),
    ("GET", "/v1/memory/conflicts"),
    ("POST", "/v1/memory/conflicts/resolve"),
    ("GET", "/v1/memory/identities"),
    ("POST", "/v1/memory/identities/owners/create"),
    ("POST", "/v1/memory/identities/owners/update"),
    ("POST", "/v1/memory/identities/aliases/link"),
    ("POST", "/v1/memory/identities/aliases/move"),
    ("POST", "/v1/memory/identities/owners/merge/preview"),
    ("POST", "/v1/memory/identities/owners/merge"),
    ("GET", "/v1/memory/maintenance/status"),
    ("POST", "/v1/memory/maintenance/index/retry"),
